...
<tr style="text-align:center"><td style="font-size:16px;font-weight:bold;color:red"><div>2次元コード</div></td></tr>
<tr style="height:5px"></tr>
<tr><td>
<table border="0" align="center" cellpadding="0" cellspacing="0" style="width:100%">
<tbody><tr align="center">
<td><img src="../images/qr_code_fpr_net_print.jpg" alt="2次元コード" width="150"></td>
</tr>
</tbody></table>
</td>
</tr>
...
<div style="text-align:center;font-size:14px">印刷可能期限<br>2026年07月30日 08時頃まで有効</div>
<div style="height:15px"></div>
<div style="font-size:16px;font-weight:bold">登録完了ファイル</div>
</div>
</td>
</tr>
<tr>
...
<tbody><tr>
<td style="width:90%">
<ul style="width:85%;word-break:break-all;text-align:left">
<li>ベネティムのエアヌードルストッパー用マーカー</li>
</ul>
</td>
</tr>
</tbody></table>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" style="width:100%">
<tbody><tr style="text-align:center">
<td style="width:100%;background:#b0a6a0;border:1px solid #ccc">
<div>
<table border="0" align="center" cellpadding="0" cellspacing="0" style="width:100%">
<tbody><tr style="height:10px"></tr>
<tr style="text-align:center">
