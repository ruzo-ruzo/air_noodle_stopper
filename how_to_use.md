...
なお前提としてカメラとブラウザを利用できる電子機器（スマホ）が必要になります。
:::
...
マーカー画像の下部についているQRコードから飛べるページに飛んでください。
QRコードから飛べない場合は以下のリンクで飛んでください。
...
多分本体のGithubのページもわかると思います。（なんならGithubのプロジェクト直でこのREADME見てます？）
